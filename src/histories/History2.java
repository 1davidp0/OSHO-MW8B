...
import gamesInstructions.Instruction2;
...
public class History2 extends JFrame {
    ...
    //********************* PANEL ********************
    PanelHistory2 panelStartGame;                               //Panel where the background image and buttons will be placed
    //************************************************
    
    public History2 () {
        //Instantiate
        
        panelStartGame = new PanelHistory2("/images/history2-1Background.png");
    ...
    //****************** SUB CLASSES *********************
    public class PanelHistory2 extends JPanel implements ActionListener {
        //Declare
        ...
        public PanelHistory2(String name) {
            //Instantiate
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource() == next) {
                soundButton.play();
                Instruction2 i2 = new Instruction2();
