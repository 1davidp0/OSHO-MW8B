...
import gamesInstructions.Instruction1;
...
//****************** MAIN CLASS **********************
public class History13 extends JFrame {
    //Declare
    ...
    //********************* PANEL ********************
    PanelHistory13 panelStartGame;                              //Panel where the background image and buttons will be placed
    //************************************************
    
    public History13 () {
        //Instantiate
        
        panelStartGame = new PanelHistory13("/images/history1-3Background.png");
    ...
    //****************** SUB CLASSES *********************
    public class PanelHistory13 extends JPanel implements ActionListener {
        //Declare
        ...
        public PanelHistory13(String name) {
            //Instantiate
            ...
            back.setContentAreaFilled(false);                  //Cancels the Back background
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource() == next) {
                soundButton.play();
                Instruction1 i1 = new Instruction1();
                dispose();                                     //Method to close the class that is open
            }
            if(e.getSource() == back) {
                soundButton.play();
                History12 h12 = new History12();
                dispose();
            }
        }
