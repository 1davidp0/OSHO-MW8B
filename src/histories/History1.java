...
public class History1 extends JFrame {
    ...
    //********************* PANEL ********************
    PanelHistory1 panelStartGame;                               //Panel where the background image and buttons will be placed
    //************************************************
    
    public History1 () {
        //Instantiate
        
        panelStartGame = new PanelHistory1("/images/history1-1Background.png");
    ...
    //****************** SUB CLASSES *********************
    public class PanelHistory1 extends JPanel implements ActionListener {
        //Declare
        ...
        public PanelHistory1(String name) {
            //Instantiate
