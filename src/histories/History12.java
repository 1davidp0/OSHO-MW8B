...
//****************** MAIN CLASS **********************
public class History12 extends JFrame {
    //Declare
    ...
    //********************* PANEL ********************
    PanelHistory12 panelStartGame;                              //Panel where the background image and buttons will be placed
    //************************************************
    
    public History12 () {
        //Instantiate
        
        panelStartGame = new PanelHistory12("/images/history1-2Background.png");
    ...
    //****************** SUB CLASSES *********************
    public class PanelHistory12 extends JPanel implements ActionListener {
        //Declare
        ...
        public PanelHistory12(String name) {
            //Instantiate
