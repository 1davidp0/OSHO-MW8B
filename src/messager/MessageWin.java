...
public class MessageWin extends JFrame {
    ...
    //********************* PANEL ********************
    PanelMessageWin paneVictory;                               //Panel where the background image and buttons will be placed
    //************************************************
    
    public MessageWin(int score) {
        //Instantiate
        
        paneVictory = new PanelMessageWin("/images/background1.png", score);
        
        soundWin = java.applet.Applet.newAudioClip(getClass().getResource("/sounds/soundVictory.wav"));
    ...
    //****************** SUB CLASSES *********************
    public class PanelMessageWin extends JPanel implements ActionListener {
        ...
        public PanelMessageWin(String name, int score) {
            //Instantiate
            ...
            labelScore1 = new JLabel("¡Felicidades! lograste pasar el");
            labelScore2 = new JLabel("nivel. Tu puntaje es: " + score);
            ...
            //***************** ADD LABELS ******************
            labelScore1.setBounds(55, 185, 1000, 50);            //Locate the position and size of the Label Name button
            labelScore2.setBounds(110, 220, 1000, 50);           //Locate the position and size of the Label Name button
